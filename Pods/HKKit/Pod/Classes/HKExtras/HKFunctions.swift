...
internal func hk_getAttributeString(_ mainString: String, attributeString: String, attributes: [NSAttributedStringKey: Any]) -> NSAttributedString {
    ...
    attrString.addAttributes(attributes, range: NSRange(location: (mainString.distance(from: mainString.startIndex, to: range.lowerBound)), length: attributeString.count))
    return attrString
...
internal func hk_getMultipleAttributesString(_ mainString: String, attributeStrings: [String], total_attributes: [[NSAttributedStringKey: Any]]) -> NSAttributedString {
    ...
    for (index, string) in attributeStrings.enumerated() {
        ...
        if range != nil {
            ...
            attrString.addAttributes(total_attributes[index], range: NSRange(location: (mainString.distance(from: mainString.startIndex, to: range!.lowerBound)), length: string.count))
