...
extension UIViewController {
    ...
    public func hk_setMainTitle(_ navigationTitle: String!) {
    ...
    public func hk_setCustomeTitleView(_ navigationTitle: String!, font: UIFont = UIFont.systemFont(ofSize: UIFont.smallSystemFontSize)) {
    ...
    public func hk_setCancelButton() {
    ...
    public func hk_setSaveButton(_ action: Selector) {
    ...
    public func hk_setCustomBackbutton(_ methodName: Selector) {
        ...
        myBackButton.imageEdgeInsets = UIEdgeInsets(top: 0, left: -20, bottom: 0, right: 0)
        myBackButton.titleEdgeInsets = UIEdgeInsets(top: 0, left: -30, bottom: 0, right: 0)
...
extension UIViewController {
    ...
    public func hk_tbl_displayInLinepickerAtIndextPath(_ indexpath: IndexPath!, tableView: UITableView) {
    ...
    public func hk_tbl_insertPickeratIndexPath(_ indexpath: IndexPath!, tableView: UITableView) {
        tableView.beginUpdates()
        if self.hk_tbl_hasInlinePicker() {
            tableView.deleteRows(at: [IndexPath(row: self.hk_tbl_pickerIndexPath.row, section: self.hk_tbl_pickerIndexPath.section)], with: .fade)
