...
extension UITextField {
    ...
    public func hk_setDefaultBottomBorder() {
    ...
    public func hk_setSelectedBottomBorder() {
   ...
   public func hk_setDefaultText(_ defaultText: String!) {
    ...
    public func hk_setLeftImgView(_ imgName: String!, contentMode: UIViewContentMode = .center) {
...
extension UITextField {
    ...
    public func hk_isEmail() -> Bool {
        ...
        return regex?.firstMatch(in: self.text!.hk_trimWhiteSpace()!, options: [], range: NSRange(location: 0, length: self.text!.hk_trimWhiteSpace()!.count)) != nil
    }
