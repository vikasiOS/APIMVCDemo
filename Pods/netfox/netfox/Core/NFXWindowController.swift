...
class NFXWindowController: NSWindowController, NSWindowDelegate, NFXWindowControllerDelegate {
    ...
    @IBAction func settingsClicked(sender: AnyObject?) {
        settingsPopover.show(relativeTo: NSRect.zero, of: settingsButton, preferredEdge: NSRectEdge.maxY)
    }

    @IBAction func infoClicked(sender: AnyObject?) {
        infoPopover.show(relativeTo: NSRect.zero, of: infoButton, preferredEdge: NSRectEdge.maxY)
    }

    @IBAction func statisticsClicked(sender: AnyObject?) {
        statisticsPopover.show(relativeTo: NSRect.zero, of: statisticsButton, preferredEdge: NSRectEdge.maxY)
    }
